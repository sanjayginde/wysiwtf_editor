class Image < ActiveRecord::Base
  ...
  #   :presence => true,
  #   :content_type => { 'image/jpeg', 'image/png', 'image/pjpeg', 'image/gif' }, #  :message => "Image must be either a JPEG, PNG, or GIF"
  #   :size => { :in => 0..10.megabytes } # :message => "Image must be less than 10 megabytes"
